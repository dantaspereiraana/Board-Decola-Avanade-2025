...
import me.dio.persistence.exception.CardBlockedException;
import me.dio.persistence.exception.CardFinishedException;
import me.dio.persistence.exception.EntityNotFoundException;
...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            ...
            if (dto.blocked()) {
                var message = "O card %s está bloqueado. É necessário desbloqueá-lo para realizar a ação.".formatted(dto.id());
    ...
    public void cancel(final Long cardId, final Long cancelColumnId,
        ...
        try {
            ...
            if (currentColumn.kind().equals(CANCEL)) {
                throw new CardFinishedException("O card já foi finalizado anteriormente.");
            }
        ...
        final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException{
            try{
                ...
                if(currentColumn.kind().equals(FINAL) || currentColumn.kind().equals(CANCEL)){
                    var messege = "O card está em uma coluna do tipo %s e não pode ser bloqueado."
                            .formatted(currentColumn.kind());
                    throw new IllegalStateException(messege);
                }
